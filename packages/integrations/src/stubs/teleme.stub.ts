...
export class TeleMeAdapterStub implements IntegrationAdapter {
  readonly slug = 'teleme';
  readonly displayName = 'TeleMe';
  ...
  describeStep(step: PlanStep): string { return `TeleMe: ${step.title}`; }
}
